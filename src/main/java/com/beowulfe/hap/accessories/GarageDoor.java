...
import com.beowulfe.hap.accessories.properties.CurrentDoorState;
...
public interface GarageDoor extends HomekitAccessory {
     ...
     */
    CompletableFuture<CurrentDoorState> getCurrentDoorState();
     ...
     */
    CompletableFuture<TargetDoorState> getTargetDoorState();
     ...
     */
    CompletableFuture<Void> setTargetDoorState(TargetDoorState state) throws Exception;
